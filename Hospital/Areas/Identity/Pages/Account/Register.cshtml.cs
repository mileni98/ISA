...
namespace Hospital.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            using (StreamReader r = new StreamReader("./Data/emailCredentials.json"))
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Admin a = new Admin(user.Id);
                        _context.Admins.Add(a);
                    }
                    else if(Input.Role == "Doctor")
                    {
                        Doctor d = new Doctor(user.Id);
                        _context.Doctors.Add(d);
                    }
                    else if(Input.Role == "Pharmacist")
                    {
                        Pharmacist p = new Pharmacist(user.Id);
                        _context.Pharmacysts.Add(p);
                    }*/
